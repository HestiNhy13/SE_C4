...
Future<void> handleLogin() async {
  ...
  if (!emailRegex.hasMatch(email)) {
    setState(() {
      emailError = 'Tulis email dengan format yang benar';
    });
    hasError = true;
  }
  ...
  if (!passwordRegex.hasMatch(password)) {
    setState(() {
      passwordError =
          'Password harus tepat 8 karakter, huruf kecil & angka';
    });
    hasError = true;
  }
  ...
  try {
    ...
    //     desc: 'Silakan daftar terlebih dahulu.',
    //     btnOkOnPress: () {},
    //     btnOkText: "Oke",
    //   ).show();
    //   return;
    ...
    AwesomeDialog(
      ...
      dialogType: DialogType.error,
      title: 'Kesalahan',
      desc: 'Terjadi kesalahan saat login: $e',
      btnOkOnPress: () {},
    ).show();
  }
}
