...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(//untuk menumpuk widget
        ...
        children: [
          ...
          Positioned(
            bottom: 50,
            child: SmoothPageIndicator(//animasi titik
              controller: _pageController,
              count: 2, // Sesuai dengan jumlah halaman PageView
              effect: ExpandingDotsEffect( // Perbaikan nama efek
                dotWidth: 8,
                dotHeight: 8,
